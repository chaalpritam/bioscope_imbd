# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-30 03:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.CharField(choices=[('G', 'General Audiences - G'), ('PG', 'Parental Guidance Suggested- PG'), ('PG-13', 'Parents Strongly Cautioned -PG-13'), ('R', 'Restriced - R'), ('NC-17', 'Adults Only - NC-17')], default='G', max_length=80)),
